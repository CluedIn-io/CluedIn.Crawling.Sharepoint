...
{
    public class DataIngestion : IClassFixture<SharePointTestFixture>
    {
        private readonly SharePointTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(SharePointTestFixture fixture, ITestOutputHelper output)
        {
