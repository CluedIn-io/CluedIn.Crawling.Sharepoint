...
{
    public class SharePoint_Command_MeshProcessor : BaseMeshProcessor
    {
        public SharePoint_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          SharePointConstants.ProviderId;
